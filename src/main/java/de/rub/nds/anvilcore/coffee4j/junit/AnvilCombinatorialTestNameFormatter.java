 ...
 */
public class AnvilCombinatorialTestNameFormatter extends CombinatorialTestNameFormatter {


    public AnvilCombinatorialTestNameFormatter(String namePattern) {
        super(namePattern);
    }
    ...
    private String replaceCombinations(String pattern, Combination testInput) {
        return pattern.replace("{combination}", ParameterCombination.fromCombination(testInput).toString());
    }
    
    private String replaceCombinations(String pattern, List<DerivationParameter> testInput) {
        return pattern.replace("{combination}", new ParameterCombination(new ArrayList<>(testInput)).toString());
    }
