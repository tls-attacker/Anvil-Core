...
public class FlexibleConditionalConstraintBuilder {
    ...
    public static FlexibleConditionalConstraintBuilder init(String name, DerivationScope derivationScope) {
    ...
    public static FlexibleConditionalConstraintBuilder init(DerivationScope derivationScope) {
        return new FlexibleConditionalConstraintBuilder("flexible-conditional-constraint", derivationScope);
    }
    ...
    public static final class FlexibleConditionalConstraintBuilder1 {
        ...
        private FlexibleConditionalConstraintBuilder1(String name, DerivationScope derivationScope, DerivationParameter target) {
            this.name = name;
            this.derivationScope = derivationScope;
            this.target = target;
        }

        public FlexibleConditionalConstraintBuilder1 requiredParameter(ParameterIdentifier requiredParameter) {
            requiredParameters.add(requiredParameter);
            return this;
        }

        public FlexibleConditionalConstraintBuilder1 requiredParameters(Collection<ParameterIdentifier> requiredParameter) {
            requiredParameters.addAll(requiredParameter);
            return this;
        }

        public FlexibleConditionalConstraintBuilder2 predicate(BiPredicate<DerivationParameter, List<DerivationParameter>> predicate) {
            return new FlexibleConditionalConstraintBuilder2(name, derivationScope, target, requiredParameters, predicate);
        }
    }
    ...
    public static final class FlexibleConditionalConstraintBuilder2 {
        ...
        private FlexibleConditionalConstraintBuilder2(String name, DerivationScope derivationScope, DerivationParameter target,
